...
ibleaders.ibupload = {
    ...
    /* 파일 추가시 자동 업로드 여부 */
    autoUpload: false,
    explicitJson: true, // true 설정시 onAddFile 의 files 는 문자열이 아닌 json 객체로 리턴된다.
    ...
    uploadServerUrl: "../../jsp/ibupload.jsp",
    downloadServerUrl: "../../jsp/ibdownload.jsp",
    ...
    iconMode: "list", //icon, list, detail
    theme: "Main", // 테마 폴더 명
    ...
    //--------------------------------------------------------------------------------
    limitFileExtServer: "html htm php php2 php3 php4 php5 phtml pwml inc asp aspx ascx jsp cfm cfc pl bat exe com dll vbs js reg cgi htaccess asis sh shtml shtm phtm msi",
