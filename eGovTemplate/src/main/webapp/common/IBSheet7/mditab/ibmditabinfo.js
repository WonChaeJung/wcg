...
ibleaders.ibmditab = {
	...
	//================================================================================
	// 탭 이동 버튼의 폭이나 위치를 변경하려면 아래를 변경하십시오.
	//================================================================================
	// UserNaviWidth : 52,
	// UserNaviTop : 8,
	// UserNaviStyle : "border:1px solid red",

	//================================================================================
	// 탭 닫기 버튼의 폭이나 스타일을 변경하려면 아래를 변경하십시오.
	//================================================================================
	// UserCloseButtonWidth : 34,
	// UserCloseButtonItemStyle : "border:1px solid red;top:3px;width:34px;height:30px;right:0px;position:absolute;cursor:pointer;",
...
//    setTimeout(function(){
//        var func = window[TabID+ "_OnloadTab2Finish"];
